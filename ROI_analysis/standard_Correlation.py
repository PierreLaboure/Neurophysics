...
def main(args=None):
    ...
    parser.add_argument('--aggLR', type=str2bool, nargs='?', const=True, default=False,
    ...
    ROI_ABSID_path = '/volatile/home/pl279327/Documents/ATLAS/atlas_data/NEW_ORDER/ATLAS_ID_ORDER.pkl'
    ABSID_ROI_path = '/volatile/home/pl279327/Documents/ATLAS/atlas_data/NEW_ORDER/ID_ATLAS_ORDER.pkl'
    ...
    # 
    if aggLR:
        # if grouping left and right regions, use the absolute IDs for regions and modify the labels map into Absolute IDs
        ...
        # if splitting left and right, add left right or middle tags to roi names
        labels2roi = get_label2roi(ROI)
