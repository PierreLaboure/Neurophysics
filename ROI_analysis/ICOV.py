...
from aggregate_utils import aggregate_ROI, ROI_FC, str2bool, ROI_ICOV
...
def main(args=None):
    ...
    FC_data_dir = os.path.join(output_path, "ICOV_data")
    FC_figures_dir = os.path.join(output_path, "ICOV_fig")
    ...
    if subsetSub:
        ...
        for confound_file in subject_list:
            ...
            matrix_name = os.path.join(FC_data_dir, image_name) + "_ICOV_data.npy"
            fig_name = os.path.join(FC_figures_dir, image_name) + "_ICOV_fig.png"
            ROI_ICOV(agg_ROI_labels, atlas_data, confound_file, fig_name, matrix_name, common_mask)
            ...
            for dir_name in dirs:
                ...
                if dir_name.startswith('_split_name_'):
                    ...
                    if len(file_list) == 1:
                        ...
                        ROI_ICOV(agg_ROI_labels, atlas_data, confound_image_path, fig_name, matrix_name)
